...
# --- Configuration ---
SOURCE_DIR = "/novel-source"
DESTINATION_DIR = "/novel-destination"
LOG_FILE = "/var/log/novel-mover.log" # Log file path within the container
...
def move_files():
    ...
    log_message("-" * 50)
    log_message("🎶 Starting novel file movement process.")
