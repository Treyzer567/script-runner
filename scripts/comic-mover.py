...
# --- Configuration ---
SOURCE_DIR = "/comic-source"
DESTINATION_DIR = "/comic-destination"
LOG_FILE = "/var/log/comic-mover.log" # Log file path within the container
...
def move_files():
    ...
    log_message("-" * 50)
    log_message("🎶 Starting comic file movement process.")
